...
<center>
<div width="90%">
<iframe src="normapplet.html?width=600&z=1&height=400&left=1&mid=0&right=1&area=a&static=0&title=1&border=0" frameborder="0" width="650" height="450" data-external="1"></iframe>
</div>
</center>
```

68-95-99.7 Rule: Approximately 68% of the observations fall within one standard deviation of the mean ($μ ± σ$), 95% within two standard deviations ($μ ± 2σ$), and 99.7% within three standard deviations ($μ ± 3σ$).


```{=html}
<center>
<div width="90%">
<iframe src="normwithtapplet.html?width=600&z=1&height=400&left=1&mid=0&right=1&area=a&static=0&title=1&border=0" frameborder="0" width="650" height="450" data-external="1"></iframe>
</div>
</center>
```