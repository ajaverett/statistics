...
The central limit theorem is the most fundamental theory in modern statistics. Without this theorem, parametric tests based on the assumption that sample data come from a population with fixed parameters determining its probability distribution would not exist. The central limit theorem states that the sampling distribution of the mean of any independent, random variable will be approximately normally distributed if the sample size is large enough. This is true regardless of the shape of the population distribution. The theorem also states that the mean of the sampling distribution will be equal to the population mean and the standard deviation of the sampling distribution will be equal to the population standard deviation divided by the square root of the sample size.
...
Using the central limit theorem, a variety of parametric tests have been developed under assumptions about the parameters that determine the population probability distribution. Compared to non-parametric tests, which do not require any assumptions about the population probability distribution, parametric tests produce more accurate and precise estimates with higher statistical powers. ([Kwak and Kim, 2017](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5370305/))
